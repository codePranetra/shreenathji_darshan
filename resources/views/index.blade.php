        ...
        <script>
            ...
            async function fetchDarshanTimings() {
                try {
                    ...
                    const timingSlotsContainer = document.getElementById('scrollTimingSlots');
    ...
    el.textContent = currentDate;
            ...
            async function fetchHeroTimings() {
                try {
                    ...
                    if (!heroTimingsList) return; // ✅ prevent crash
