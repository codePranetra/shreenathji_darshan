...
@section('meta-tags')
    ...
    <meta name="description"
        content="Shreenathji darshan, Nathdwara booking portal - mandir location, book hotel, restaurant, taxi, street food and all services in Nathdwara.">
    <meta name="keywords"
        content="Shreenathdwara, Nathdwara, Shreenathji darshan today, Nathdwara darshan today, Shreenathji darshan timing today, Shreenathji mandir, श्रीनाथजी दर्शन, Shreenathji temple, Shrinathji Darshan Timings Today, Nathdwara Temple Schedule, Mangala Darshan Time Nathdwara, Rajbhog Darshan Shrinathji, Shrinathji Temple Official Website, Statue of Belief Nathdwara, Vishwas Swaroopam Shiva Statue Timing, World's Tallest Shiva Statue Nathdwara, Statue of Belief Laser Show Time, Statue of Belief Glass Bridge Ticket, Best Hotels in Nathdwara near Temple, Nathdwara Dharamshala Booking, Parking near Shrinathji Temple Nathdwara, Best Places to Eat in Nathdwara, Udaipur to Nathdwara Distance and taxi, Shreenathji darshan booking online, Shreenathji vip darshan, Shreenathji mandir, Shreeji temple, Best hotel in Nathdwara, Best restaurant in Nathdwara, Taxi booking Nathdwara">
    <meta name="author" content="Shreenathji Darshan Nathdwara Booking Portal">
    <meta property="og:title" content="Shreenathji Darshan Nathdwara Booking Portal">
    <meta property="og:description"
        content="Shreenathji darshan today, Nathdwara temple schedule, VIP darshan, hotels, restaurants, taxi booking and complete Nathdwara guide.">
    {{--
    <meta property="og:image" content="URL_to_an_image.jpg"> --}}
    <meta property="og:url" content="{{ url()->current() }}">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Shreenathji Darshan Nathdwara Booking Portal">
    <meta name="twitter:description"
        content="Check Shreenathji darshan timing today, book darshan, hotels, food, taxi and explore Nathdwara यात्रा guide.">
    {{--
    ...
    <!--
            <div class="section-divider">
                <svg width="100%" height="60" viewBox="0 0 400 60">
                    <path d="M 0 30 Q 50 10 100 30 Q 150 50 200 30 Q 250 10 300 30 Q 350 50 400 30"
            ...
            <div class="container">
                <div class="about-content">
                    ...
                    <div class="about-image">
                        <img src="images/about us by client.jpeg" alt="Shrinathji Pichwai Art"
                ...
                data.forEach(timing => {
                    ...
                    row.innerHTML = `
                                                                                                                                                                ...
                                                                                                                                                                <div class="pichwai-right">
                                                                                                                                                                    <h2>${timing.title || 'N/A'} ${status.label !== 'Closed' ? `(${status.label})` : ''}</h2>
                                                                                                                                                                </div>
                                                                                                                                                            `;
